...
// --- DADOS REAIS DA COPA DO MUNDO 2026 (FASE DE GRUPOS ATUALIZADA) ---
const jogos = {
  rodada1: [
    { id: "A1", timeA: "México", timeB: "África do Sul", siglaA: "mx", siglaB: "za", data: "11/06 • Quinta", hora: "19:00", local: "Cidade do México" },
    { id: "A2", timeA: "Coreia do Sul", timeB: "Tchéquia", siglaA: "kr", siglaB: "cz", data: "11/06 • Quinta", hora: "22:00", local: "Guadalajara" },
    { id: "B1", timeA: "Canadá", timeB: "Bósnia", siglaA: "ca", siglaB: "ba", data: "12/06 • Sexta", hora: "19:00", local: "Toronto" },
    { id: "D1", timeA: "EUA", timeB: "Paraguai", siglaA: "us", siglaB: "py", data: "12/06 • Sexta", hora: "21:00", local: "Los Angeles" },
    { id: "B2", timeA: "Catar", timeB: "Suíça", siglaA: "qa", siglaB: "ch", data: "13/06 • Sábado", hora: "15:00", local: "San Francisco" },
    { id: "C1", timeA: "Brasil", timeB: "Marrocos", siglaA: "br", siglaB: "ma", data: "13/06 • Sábado", hora: "18:00", local: "Nova York/NJ" },
    { id: "C2", timeA: "Haiti", timeB: "Escócia", siglaA: "ht", siglaB: "gb-sct", data: "13/06 • Sábado", hora: "21:00", local: "Boston" },
    { id: "D2", timeA: "Austrália", timeB: "Turquia", siglaA: "au", siglaB: "tr", data: "13/06 • Sábado", hora: "23:00", local: "Vancouver" },
    { id: "E1", timeA: "Alemanha", timeB: "Curaçao", siglaA: "de", siglaB: "cw", data: "14/06 • Domingo", hora: "15:00", local: "Houston" },
    { id: "E2", timeA: "Costa do Marfim", timeB: "Equador", siglaA: "ci", siglaB: "ec", data: "14/06 • Domingo", hora: "19:00", local: "Philadelphia" },
    { id: "F1", timeA: "Holanda", timeB: "Japão", siglaA: "nl", siglaB: "jp", data: "14/06 • Domingo", hora: "17:00", local: "Dallas" },
    { id: "F2", timeA: "Suécia", timeB: "Tunísia", siglaA: "se", siglaB: "tn", data: "14/06 • Domingo", hora: "21:00", local: "Monterrey" },
    { id: "G1", timeA: "Bélgica", timeB: "Egito", siglaA: "be", siglaB: "eg", data: "15/06 • Segunda", hora: "15:00", local: "Seattle" },
    { id: "G2", timeA: "Irã", timeB: "Nova Zelândia", siglaA: "ir", siglaB: "nz", data: "15/06 • Segunda", hora: "21:00", local: "Los Angeles" },
    { id: "H1", timeA: "Espanha", timeB: "Cabo Verde", siglaA: "es", siglaB: "cv", data: "15/06 • Segunda", hora: "12:00", local: "Atlanta" },
    { id: "H2", timeA: "Arábia Saudita", timeB: "Uruguai", siglaA: "sa", siglaB: "uy", data: "15/06 • Segunda", hora: "18:00", local: "Miami" },
    { id: "I1", timeA: "França", timeB: "Senegal", siglaA: "fr", siglaB: "sn", data: "16/06 • Terça", hora: "15:00", local: "Nova York/NJ" },
    { id: "I2", timeA: "Iraque", timeB: "Noruega", siglaA: "iq", siglaB: "no", data: "16/06 • Terça", hora: "18:00", local: "Boston" },
    { id: "J1", timeA: "Argentina", timeB: "Argélia", siglaA: "ar", siglaB: "dz", data: "16/06 • Terça", hora: "21:00", local: "Kansas City" },
    { id: "J2", timeA: "Áustria", timeB: "Jordânia", siglaA: "at", siglaB: "jo", data: "16/06 • Terça", hora: "00:00", local: "San Francisco" },
    { id: "K1", timeA: "Portugal", timeB: "RD Congo", siglaA: "pt", siglaB: "cd", data: "17/06 • Quarta", hora: "15:00", local: "Houston" },
    { id: "K2", timeA: "Uzbequistão", timeB: "Colômbia", siglaA: "uz", siglaB: "co", data: "17/06 • Quarta", hora: "18:00", local: "Cidade do México" },
    { id: "L1", timeA: "Inglaterra", timeB: "Croácia", siglaA: "gb-eng", siglaB: "hr", data: "17/06 • Quarta", hora: "16:00", local: "Dallas" },
    { id: "L2", timeA: "Gana", timeB: "Panamá", siglaA: "gh", siglaB: "pa", data: "17/06 • Quarta", hora: "19:00", local: "Toronto" }
  ],
  rodada2: [
    { id: "A3", timeA: "México", timeB: "Coreia do Sul", siglaA: "mx", siglaB: "kr", data: "18/06 • Quinta", hora: "21:00", local: "Guadalajara" },
    { id: "A4", timeA: "África do Sul", timeB: "Tchéquia", siglaA: "za", siglaB: "cz", data: "18/06 • Quinta", hora: "15:00", local: "Atlanta" },
    { id: "B3", timeA: "Canadá", timeB: "Suíça", siglaA: "ca", siglaB: "ch", data: "18/06 • Quinta", hora: "18:00", local: "Vancouver" },
    { id: "B4", timeA: "Bósnia", timeB: "Catar", siglaA: "ba", siglaB: "qa", data: "18/06 • Quinta", hora: "21:00", local: "Los Angeles" },
    { id: "C3", timeA: "Brasil", timeB: "Haiti", siglaA: "br", siglaB: "ht", data: "19/06 • Sexta", hora: "21:00", local: "Philadelphia" },
    { id: "C4", timeA: "Marrocos", timeB: "Escócia", siglaA: "ma", siglaB: "gb-sct", data: "19/06 • Sexta", hora: "18:00", local: "Boston" },
    { id: "D3", timeA: "EUA", timeB: "Austrália", siglaA: "us", siglaB: "au", data: "19/06 • Sexta", hora: "20:00", local: "Seattle" },
    { id: "D4", timeA: "Paraguai", timeB: "Turquia", siglaA: "py", siglaB: "tr", data: "19/06 • Sexta", hora: "15:00", local: "San Francisco" },
    { id: "E3", timeA: "Alemanha", timeB: "Costa do Marfim", siglaA: "de", siglaB: "ci", data: "20/06 • Sábado", hora: "15:00", local: "Toronto" },
    { id: "E4", timeA: "Curaçao", timeB: "Equador", siglaA: "cw", siglaB: "ec", data: "20/06 • Sábado", hora: "18:00", local: "Kansas City" },
    { id: "F3", timeA: "Holanda", timeB: "Suécia", siglaA: "nl", siglaB: "se", data: "20/06 • Sábado", hora: "18:00", local: "Houston" },
    { id: "F4", timeA: "Japão", timeB: "Tunísia", siglaA: "jp", siglaB: "tn", data: "20/06 • Sábado", hora: "21:00", local: "Monterrey" },
    { id: "G3", timeA: "Bélgica", timeB: "Irã", siglaA: "be", siglaB: "ir", data: "21/06 • Domingo", hora: "15:00", local: "Miami" },
    { id: "G4", timeA: "Egito", timeB: "Nova Zelândia", siglaA: "eg", siglaB: "nz", data: "21/06 • Domingo", hora: "18:00", local: "Atlanta" },
    { id: "H3", timeA: "Espanha", timeB: "Arábia Saudita", siglaA: "es", siglaB: "sa", data: "21/06 • Domingo", hora: "21:00", local: "Los Angeles" },
    { id: "H4", timeA: "Cabo Verde", timeB: "Uruguai", siglaA: "cv", siglaB: "uy", data: "21/06 • Domingo", hora: "21:00", local: "Seattle" },
    { id: "I3", timeA: "França", timeB: "Iraque", siglaA: "fr", siglaB: "iq", data: "22/06 • Segunda", hora: "15:00", local: "Nova York/NJ" },
    { id: "I4", timeA: "Senegal", timeB: "Noruega", siglaA: "sn", siglaB: "no", data: "22/06 • Segunda", hora: "18:00", local: "Boston" },
    { id: "J3", timeA: "Argentina", timeB: "Áustria", siglaA: "ar", siglaB: "at", data: "22/06 • Segunda", hora: "21:00", local: "Dallas" },
    { id: "J4", timeA: "Argélia", timeB: "Jordânia", siglaA: "dz", siglaB: "jo", data: "22/06 • Segunda", hora: "15:00", local: "San Francisco" },
    { id: "K3", timeA: "Portugal", timeB: "Uzbequistão", siglaA: "pt", siglaB: "uz", data: "23/06 • Terça", hora: "18:00", local: "Toronto" },
    { id: "K4", timeA: "RD Congo", timeB: "Colômbia", siglaA: "cd", siglaB: "co", data: "23/06 • Terça", hora: "21:00", local: "Houston" },
    { id: "L3", timeA: "Inglaterra", timeB: "Gana", siglaA: "gb-eng", siglaB: "gh", data: "23/06 • Terça", hora: "15:00", local: "Kansas City" },
    { id: "L4", timeA: "Croácia", timeB: "Panamá", siglaA: "hr", siglaB: "pa", data: "23/06 • Terça", hora: "21:00", local: "Cidade do México" }
  ],
  rodada3: [
    { id: "A5", timeA: "México", timeB: "Tchéquia", siglaA: "mx", siglaB: "cz", data: "24/06 • Quarta", hora: "15:00", local: "Cidade do México" },
    { id: "A6", timeA: "África do Sul", timeB: "Coreia do Sul", siglaA: "za", siglaB: "kr", data: "24/06 • Quarta", hora: "15:00", local: "Monterrey" },
    ...
    { id: "D5", timeA: "EUA", timeB: "Turquia", siglaA: "us", siglaB: "tr", data: "24/06 • Quarta", hora: "22:00", local: "Boston" },
    { id: "D6", timeA: "Paraguai", timeB: "Austrália", siglaA: "py", siglaB: "au", data: "24/06 • Quarta", hora: "22:00", local: "Vancouver" },
    { id: "E5", timeA: "Alemanha", timeB: "Equador", siglaA: "de", siglaB: "ec", data: "25/06 • Quinta", hora: "15:00", local: "Philadelphia" },
    { id: "E6", timeA: "Curaçao", timeB: "Costa do Marfim", siglaA: "cw", siglaB: "ci", data: "25/06 • Quinta", hora: "15:00", local: "Nova York/NJ" },
    { id: "F5", timeA: "Holanda", timeB: "Tunísia", siglaA: "nl", siglaB: "tn", data: "25/06 • Quinta", hora: "18:00", local: "Dallas" },
    { id: "F6", timeA: "Japão", timeB: "Suécia", siglaA: "jp", siglaB: "se", data: "25/06 • Quinta", hora: "18:00", local: "Kansas City" },
    { id: "B5", timeA: "Canadá", timeB: "Catar", siglaA: "ca", siglaB: "qa", data: "25/06 • Quinta", hora: "21:00", local: "San Francisco" },
    { id: "B6", timeA: "Bósnia", timeB: "Suíça", siglaA: "ba", siglaB: "ch", data: "25/06 • Quinta", hora: "21:00", local: "Los Angeles" },
    { id: "G5", timeA: "Bélgica", timeB: "Nova Zelândia", siglaA: "be", siglaB: "nz", data: "26/06 • Sexta", hora: "15:00", local: "Miami" },
    { id: "G6", timeA: "Egito", timeB: "Irã", siglaA: "eg", siglaB: "ir", data: "26/06 • Sexta", hora: "15:00", local: "Atlanta" },
    { id: "H5", timeA: "Espanha", timeB: "Uruguai", siglaA: "es", siglaB: "uy", data: "26/06 • Sexta", hora: "18:00", local: "Houston" },
    { id: "H6", timeA: "Cabo Verde", timeB: "Arábia Saudita", siglaA: "cv", siglaB: "sa", data: "26/06 • Sexta", hora: "18:00", local: "Guadalajara" },
    { id: "I5", timeA: "França", timeB: "Noruega", siglaA: "fr", siglaB: "no", data: "26/06 • Sexta", hora: "21:00", local: "Boston" },
    { id: "I6", timeA: "Senegal", timeB: "Iraque", siglaA: "sn", siglaB: "iq", data: "26/06 • Sexta", hora: "21:00", local: "Vancouver" },
    { id: "J5", timeA: "Argentina", timeB: "Jordânia", siglaA: "ar", siglaB: "jo", data: "27/06 • Sábado", hora: "15:00", local: "Philadelphia" },
    { id: "J6", timeA: "Argélia", timeB: "Áustria", siglaA: "dz", siglaB: "at", data: "27/06 • Sábado", hora: "15:00", local: "Nova York/NJ" },
    { id: "K5", timeA: "Portugal", timeB: "Colômbia", siglaA: "pt", siglaB: "co", data: "27/06 • Sábado", hora: "18:00", local: "Dallas" },
    { id: "K6", timeA: "RD Congo", timeB: "Uzbequistão", siglaA: "cd", siglaB: "uz", data: "27/06 • Sábado", hora: "18:00", local: "Kansas City" },
    { id: "L5", timeA: "Inglaterra", timeB: "Panamá", siglaA: "gb-eng", siglaB: "pa", data: "27/06 • Sábado", hora: "21:00", local: "San Francisco" },
    { id: "L6", timeA: "Croácia", timeB: "Gana", siglaA: "hr", siglaB: "gh", data: "27/06 • Sábado", hora: "21:00", local: "Los Angeles" }
  ]
};
// --- ELEMENTOS DA TELA ---
